 ...
 * Compilar:   gcc -Wall Client.c -o Client
 * Uso:        ./Client Endereco_IP_ou_nome_do_servidor porta_para_enviar_pro_servidor(1234) porta_para_receber_do_servidor(23)
 *
 * Autor:      Andre Coladello / Lucas Ryu / Victor Daisuke
 * 
 *
 */
